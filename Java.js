...
monthNameE1.innerText = date.toLocaleDateString("english",{month:"long"});


dayNameE1.innerText = date.toLocaleDateString("english",{weekday:"long"});

dayNumberE1.innerText = date.getDate("en");
